 ...
 * ----------------------------------------
 * |SECONDS	TPS	TOTAL_MEMORY_USAGE|
 * |...		...	...               |
 * |...		...	...               |
 * |...		...	...               |
 * ----------------------------------------
...
void logger::log_swap_usage(const std::pair<size_t,size_t>& p) { _swap_usage.push_back(p); }
